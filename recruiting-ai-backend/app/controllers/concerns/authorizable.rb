...
module Authorizable
  ...
  def require_super_admin!
    forbid! unless current_user.super_admin?
  end

  def require_admin!
    forbid! unless current_user.super_admin? || current_user.admin?
  end

  def require_recruiter_or_admin!
    forbid! unless current_user.super_admin? || current_user.admin? || current_user.recruiter?
  end
  ...
  def require_can_view_jobs!
    forbid! unless current_user.super_admin? || current_user.admin? || current_user.recruiter? || current_user.hiring_manager?
  end
  ...
  def require_can_view_interviews!
    forbid! unless current_user.super_admin? || current_user.admin? || current_user.recruiter? || current_user.hiring_manager? || current_user.interviewer?
  end
  ...
  def require_interviewer_assigned_to!(interview)
    return if current_user.super_admin? || current_user.admin? || current_user.recruiter? || current_user.hiring_manager?
